...
export default function ProductDetail() {
  ...
  const handleCart = (e) => {
    e.preventDefault();
    if (user && items.findIndex((item) => item.productId === product.id) < 0) {
      const newItem = {
        ...product,
              ...
              <div className="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <form className="mt-10">
                  ...
                  <button
                    onClick={handleBuy}
                    type="submit"
                    className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-700 px-8 py-3 text-base font-medium text-white hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    Buy Now
                  </button>
                </form>
